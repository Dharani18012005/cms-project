    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-purple-400  rounded-4xl shadow-md p-2 flex flex-col items-center">
                ...
                <div className="bg-purple-300  rounded-4xl shadow-md p-2 flex flex-col items-center">
